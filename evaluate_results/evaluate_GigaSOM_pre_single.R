...
library(flowCore)
library(clue)
setwd("~/work/GigaSOM_data/validation_results/Weber_cytof_comparison/cytometry-clustering-comparison/helpers")
...
DATA_DIR <- "~/work/GigaSOM_data/validation_results/Weber_cytof_comparison"
